...
public class ItemRepositoryTests {
    ...
    public void givenCreatedItem_whenFindByOwnerId_thenListItemSize1() {
        ...
        //when
        List<Item> obtainedItems = itemRepository.findByOwnerIdOrderByIdAsc(createdUser.getId(), Pageable.unpaged());
    ...
    public void givenThreeItem_whenFindItemByDescriptionOrName_thenReturnedTwoItem() {
        ...
        List<Item> obtainedItems = itemRepository.findByNameOrDescription(textToFind, true, Pageable.unpaged());
