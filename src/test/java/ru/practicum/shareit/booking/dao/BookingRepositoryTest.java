...
public class BookingRepositoryTest {
    ...
    public void givenTwoBooking_thenSaveTwoBooking_WhenReturnedTwoBookingByBookerId() {
        ...
        //when
        List<Booking> obtainedBookings = bookingRepository.findByBookerIdOrderByStartDesc(booker.getId(), Pageable.unpaged());
    ...
    public void givenBooking_thenSaveTwoBooking_WhenReturnedBookingByBookerIdAndEndLessThen() {
        ...
        //when
        List<Booking> obtainedBooking = bookingRepository.findByBookerIdAndEndLessThanOrderByStartDesc(booker.getId(), end.plusDays(2), Pageable.unpaged());
    ...
    public void givenBooking_thenSaveTwoBooking_WhenReturnedBookingByBookerIdAndStartEarly() {
        ...
        //when
        List<Booking> obtainedBooking = bookingRepository.findByBookerIdAndStartGreaterThanOrderByStartDesc(booker.getId(), start.minusDays(2), Pageable.unpaged());
    ...
    public void givenBooking_thenSaveTwoBooking_WhenReturnedBookingByBookerIdAndStatus() {
        ...
        //when
        List<Booking> obtainedBooking = bookingRepository.findByBookerIdAndStatusOrderByStartDesc(booker.getId(), Status.WAITING, Pageable.unpaged());
